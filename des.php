...
<div class="mainBase">
  ...
  <div class="desc">All picture is all about realated to the subject</div>
</div>
  <script>
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 960px; height: 480px; overflow: hidden; visibility: hidden; background-color:rgba(90,90,90,0.5)">
        <!-- Loading Screen -->
    ...
    <!-- Script for text animation scrolling -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script type="text/javascript">            
            (function() {                
    ...
    <!-- For Scroll and intro disappears -->
    <script>
      (function() {
        ...
        $(document).on('click', function() {
          introEl.slideUp(1000, function() { $(document).on('scroll'); });
        });
      })();
    </script>
